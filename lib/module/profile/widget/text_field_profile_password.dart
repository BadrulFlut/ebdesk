...
class textFieldProfilePassword extends StatefulWidget {
  String? text;
  TextEditingController controller;
  String? hintText;
  textFieldProfilePassword({
    required this.text,
  ...
  @override
  State<textFieldProfilePassword> createState() =>
      _textFieldProfilePasswordState();
}

class _textFieldProfilePasswordState extends State<textFieldProfilePassword> {
  bool visible = false;
